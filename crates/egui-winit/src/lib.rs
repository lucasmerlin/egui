    ...
    pub fn on_event(
        ...
        match event {
            ...
            WindowEvent::ModifiersChanged(state) => {
                self.egui_input.modifiers.alt = state.lalt_state()
                    == winit::keyboard::ModifiersKeyState::Pressed
                    || state.ralt_state() == winit::keyboard::ModifiersKeyState::Pressed;
                self.egui_input.modifiers.ctrl = state.lcontrol_state()
                    == winit::keyboard::ModifiersKeyState::Pressed
                    || state.rcontrol_state() == winit::keyboard::ModifiersKeyState::Pressed;
                self.egui_input.modifiers.shift = state.lshift_state()
                    == winit::keyboard::ModifiersKeyState::Pressed
                    || state.rshift_state() == winit::keyboard::ModifiersKeyState::Pressed;
                self.egui_input.modifiers.mac_cmd = cfg!(target_os = "macos")
                    && (state.lsuper_state() == winit::keyboard::ModifiersKeyState::Pressed
                        || state.rsuper_state() == winit::keyboard::ModifiersKeyState::Pressed);
                self.egui_input.modifiers.command = if cfg!(target_os = "macos") {
                    state.lsuper_state() == winit::keyboard::ModifiersKeyState::Pressed
                        || state.rsuper_state() == winit::keyboard::ModifiersKeyState::Pressed
                } else {
                    state.lcontrol_state() == winit::keyboard::ModifiersKeyState::Pressed
                        || state.rcontrol_state() == winit::keyboard::ModifiersKeyState::Pressed
                };
                EventResponse {
                    repaint: true,
